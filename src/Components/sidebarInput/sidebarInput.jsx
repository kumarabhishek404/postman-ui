  ...
  return (
    ...
    >
      <Tabs
        ...
        sx={{ borderRight: 1, borderColor: 'divider', outline: 'none !important' }}
      >
        <Tab sx={{
          fontSize: '7px',
          ...
          minWidth: '0px',
          padding: '10px 20px',
          '& .MuiButtonBase-root MuiTab-root MuiTab-labelIcon MuiTab-textColorPrimary Mui-selected css-148os2o-MuiButtonBase-root-MuiTab-root': {
      ...
      <TabPanel style={{ width: '75%' }}
        ...
        <div className='sidebar_container_2_container'>
          ...
          <div className='sidebar_items_section'>
            <div>
              <figure>Picture</figure>
            </div>
            <div>
              <p className='sidebar_items_section_heading p-0 m-0 my-2'>Create a collection for your requests</p>
            </div>
            <div>
              <p className='sidebar_items_section_text p-0 m-0 px-2'>A collection lets you group related requests and easily set common authorization, tests, scripts, and variables for all requests in it.</p>
            </div>
            <div>
              <p className='sidebar_items_section_link p-0 m-0 my-2'>Create collection</p>
            </div>
          </div>
        </div>
      </TabPanel>
      <TabPanel style={{ width: '75%' }} value={value} index={1}>
        <div className='sidebar_container_2_container'>
          ...
          <div className='sidebar_items_section'>
            ...
            <div>
              <p className='sidebar_items_section_heading p-0 m-0 my-2'>No APIs yet</p>
            </div>
            <div>
              <p className='sidebar_items_section_text p-0 m-0 px-2'>APIs define related collections and environments under a consistent schema.</p>
            </div>
            <div>
              <p className='sidebar_items_section_link p-0 m-0 my-2'>Create an API</p>
            </div>
          </div>
        </div>
      </TabPanel>
      <TabPanel style={{ width: '75%' }} value={value} index={2}>
        <div className='sidebar_container_2_container'>
          ...
          <div className='sidebar_items_section'>
            ...
            <div>
              <p className='sidebar_items_section_heading p-0 m-0 my-2'>You don’t have any environments.</p>
            </div>
            <div>
              <p className='sidebar_items_section_text p-0 m-0 px-2'>An environment is a set of variables that allows you to switch the context of your requests.</p>
            </div>
            <div>
              <p className='sidebar_items_section_link p-0 m-0 my-2'>Create Environment</p>
            </div>
          </div>
        </div>
      </TabPanel>
      <TabPanel style={{ width: '75%' }} value={value} index={3}>
        <div className='sidebar_container_2_container'>
          ...
          <div className='sidebar_items_section'>
            ...
            <div>
              <p className='sidebar_items_section_heading p-0 m-0 my-2'>You don’t have any mock servers.</p>
            </div>
            <div>
              <p className='sidebar_items_section_text p-0 m-0 px-2'>Mock servers let you simulate endpoints and their corresponding responses in a collection without actually setting up a back end.</p>
            </div>
            <div>
              <p className='sidebar_items_section_link p-0 m-0 my-2'>Create Mock Server</p>
            </div>
          </div>
        </div>
      </TabPanel>
      <TabPanel style={{ width: '75%' }} value={value} index={4}>
        <div className='sidebar_container_2_container'>
          ...
          <div className='sidebar_items_section'>
            ...
            <div>
              <p className='sidebar_items_section_heading p-0 m-0 my-2'>You have no monitors set up</p>
            </div>
            <div>
              <p className='sidebar_items_section_text p-0 m-0 px-2'>A monitor lets you run a collection periodically to check for its performance and response.</p>
            </div>
            <div>
              <p className='sidebar_items_section_link p-0 m-0 my-2'>Create a Monitor</p>
            </div>
          </div>
        </div>
      </TabPanel>
      <TabPanel style={{ width: '75%' }} value={value} index={5}>
        <div className='sidebar_container_2_container w-100'>
          ...
          <div className='sidebar_items_section'>
            ...
            <div>
              <p className='sidebar_items_section_heading p-0 m-0 my-2'>Create your first Flow</p>
            </div>
            <div>
              <p className='sidebar_items_section_text p-0 m-0 px-2'>Flows help you create API workflows by connecting series of requests through a drag-and-drop UI.</p>
            </div>
            <div>
              <p className='sidebar_items_section_link p-0 m-0 my-2'>Create Flow</p>
            </div>
          </div>
        </div>
      </TabPanel>
          ...
          </div>
          {
            props.historyList != []
              ...
              <div className='sidebar_items_section'>
                ...
                <div>
                  <p className='sidebar_items_section_heading p-0 m-0 my-2'>You haven't sent any requests.</p>
                </div>
                <div>
                  <p className='sidebar_items_section_text p-0 m-0 px-2'>Any request you send in this workspace will appear here.</p>
                </div>
                <div>
                  <p className='sidebar_items_section_link p-0 m-0 my-2'>Show me how</p>
                </div>
              </div>
          }
        </div>
